...
; (function () {
	...
	window.xCal = function (ob, delim, order) { // xCal(this,'-',1) // xCal() == close
		...
		xCal.f = function (a) {
			...
			HTM(a.id, '<thead><tr><td class="cal-l" title="' + lang[a.lang].pre + '">прошл</td><td colspan=3 class="cal-m"></td><td colspan=2 class="cal-y"></td><td class="cal-r" title="' + lang[a.lang].nex + '">след</td></tr><tr><td>' + lang[a.lang].w + '</td></tr></thead>');
